...
RSpec.describe Admin::TeamMembersController, type: :controller do
  ...
  # Admin::TeamMembersController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested admin_team_member as @admin_team_member" do
      ...
      expect(assigns(:admin_team_member)).to eq(team_member)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new admin_team_member as @admin_team_member" do
      ...
      expect(assigns(:admin_team_member)).to be_a_new(TeamMember)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new TeamMember" do
        expect {
          post :create, {:admin_team_member => valid_attributes}, valid_session
        }.to change(TeamMember, :count).by(1)
      end

      it "assigns a newly created admin_team_member as @admin_team_member" do
        post :create, {:admin_team_member => valid_attributes}, valid_session
        expect(assigns(:admin_team_member)).to be_a(TeamMember)
        expect(assigns(:admin_team_member)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved admin_team_member as @admin_team_member" do
        post :create, {:admin_team_member => invalid_attributes}, valid_session
        expect(assigns(:admin_team_member)).to be_a_new(TeamMember)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_team_member" do
        team_member = TeamMember.create! valid_attributes
        put :update, {:id => team_member.to_param, :admin_team_member => new_attributes}, valid_session
        team_member.reload
      ...
      it "assigns the requested admin_team_member as @admin_team_member" do
        team_member = TeamMember.create! valid_attributes
        put :update, {:id => team_member.to_param, :admin_team_member => valid_attributes}, valid_session
        expect(assigns(:admin_team_member)).to eq(team_member)
      end
    ...
    context "with invalid params" do
      it "assigns the admin_team_member as @admin_team_member" do
        team_member = TeamMember.create! valid_attributes
        put :update, {:id => team_member.to_param, :admin_team_member => invalid_attributes}, valid_session
        expect(assigns(:admin_team_member)).to eq(team_member)
      end
