class Admin::TeamMembersController < ApplicationController
  ...
  def new
    @team_member = TeamMember.new team_id: params[:team_id]
  end
  ...
  def create
    ...
    respond_to do |format|
      if @team_member.save
        format.html { redirect_to admin_team_member_url(@team_member.team, @team_member),
          notice: 'Team member was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @team_member.update(team_member_params)
        format.html { redirect_to admin_team_member_url(@team_member.team, @team_member),
          notice: 'Team member was successfully updated.' }
  ...
  private
    ...
    def team_member_params
      params.require(:team_member).permit(:name, :short_name, :team_id)
    end
end
